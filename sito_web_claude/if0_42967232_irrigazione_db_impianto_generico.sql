...
--
-- Struttura della tabella `elettrovalvole`
--

CREATE TABLE `elettrovalvole` (
  `id_elettrovalvola` int(11) NOT NULL,
  `nome_elettrovalvola` varchar(30) NOT NULL
...
CREATE TABLE `schedulazione` (
  ...
  `elettrovalvole_da_usare` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `schedulazione` (`id_giorno`, `ora_inizio`, `durata`, `elettrovalvole_da_usare`) VALUES
(0, '19:45', 1.30, ''),
(1, NULL, NULL, ''),
(2, NULL, NULL, ''),
(3, NULL, NULL, ''),
