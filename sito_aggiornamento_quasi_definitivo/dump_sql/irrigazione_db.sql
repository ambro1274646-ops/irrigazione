...
--
-- Host: 127.0.0.1
-- Creato il: Set 23, 2026 alle 23:38
...
('ambro', 'rP5SqgZBnSECBTue4IIFYrbjlk6ljaiq'),
('ambro', 'ikKl8lK2w6rTaYBHpl813i7a7fR3WxXn');
...
--
-- Dump dei dati per la tabella `super_utenti`
--

INSERT INTO `super_utenti` (`id_utente`, `id_impianto`, `nome_db_impianto`) VALUES
(2, 5000, 'irrigazione_db_campo_via_saluzzo'),
(2, 5001, 'irrigazione_db_campo_via_torino');
...
(1, 'ambro', 'Azienda Agricola Demo', NULL, 'password', 'f', 1, 'irrigazione_db_impianto_generico'),
(2, 'francesco', 'azienda_agricola_1', NULL, 'password', 't', NULL, NULL);
